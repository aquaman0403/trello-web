...
function AccountTab() {
  ...
  const submitChangeGeneralInformation = (data) => {
    ...
    toast.promise(
      ...
      // Kiểm tra không có lỗi (update thành công) thì thực hiện các hành động cần thiết
      if (!res.error) {
  ...
  const uploadAvatar = (e) => {
    ...
    toast.promise(
      ...
      // Lưu ý dù có lỗi hoặc thành công thì cũng phải clear giá trị của file input, nếu không thì sẽ không thể chọn cùng 1 file liên tiếp được
      e.target.value = ''
    })
  }
