...
function ActiveCard() {
  ...
  // Function gọi Api dùng chung cho các trường hợp update card (title, desciption)
  ...
  const onUpdateCardMembers = async (incommingMemberInfo) => {
    await callApiUpdateCard({ incommingMemberInfo })
  }
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid size={{ xs: 12, sm: 3 }}>
            ...
            <Stack direction="column" spacing={1}>
               ...
               * Khi click vào nút Join thì nó luôn là hành động ADD
               */}
